    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hrm_api.department')),
        ...
        migrations.AddField(
            model_name='staff',
            name='departments',
            field=models.ManyToManyField(through='hrm_api.StaffDepartment', to='hrm_api.Department'),
        ),
        migrations.AddField(
            model_name='staff',
            name='groups',
