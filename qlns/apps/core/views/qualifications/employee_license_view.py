...
class EmployeeLicenseView(viewsets.ModelViewSet):
    serializer_class = qualification_serializers.EmployeeLicenseSerializer

    def get_queryset(self):
        return core_models.EmployeeLicense.objects.filter(owner=self.kwargs['employee_pk'])
